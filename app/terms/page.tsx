...
export default function TermsOfService() {
  return (
    <>
      <Head>
        <title>이용약관 | launch-fit.vercel.app</title>
      </Head>
      <div className="min-h-screen flex flex-col items-center justify-center bg-white text-gray-900 px-6">
        <div className="w-full max-w-2xl bg-zinc-100 p-6 rounded-lg shadow-md text-left">
          ...
          <p className="mb-4">
            본 서비스 launch-fit.vercel.app(이하 ‘서비스’)를 이용해 주셔서 감사합니다. 본 약관은 서비스 이용과 관련하여
            사용자와 launch-fit.vercel.app 간의 권리 및 의무를 명시합니다.
          </p>
